...
string_max_len = 10 if "random" in opt.train_path else 15
regex_max_len = 250 if "random" in opt.train_path else 250

train = dataset.get_loader(train_path, batch_size, shuffle=True, string_max_len=string_max_len, regex_max_len=regex_max_len)
dev = dataset.get_loader(valid_path, batch_size, shuffle=False, string_max_len=string_max_len, regex_max_len=regex_max_len)
...
t = SupervisedTrainer(
    ...
    print_every=100,
    expt_dir=expt_dir,
    max_sequence_length=regex_max_len,
)
